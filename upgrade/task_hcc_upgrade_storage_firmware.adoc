...
* *Upgrade process time* You have scheduled sufficient time to perform your upgrade. The upgrade process time varies depending on the Element software version and firmware updates. 
+
...
|Your management node is within a dark site without external connectivity.
a|
. Download the storage firmware upgrade package to a device that is accessible to the management node; go to the Element software https://mysupport.netapp.com/site/products/all/details/element-software/downloads-tab[downloads page^] and download the latest storage firmware image.
