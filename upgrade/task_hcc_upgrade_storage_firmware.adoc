...
NOTE: For a complete matrix of firmware and driver firmware for your hardware, see https://docs.netapp.com/us-en/hci/docs/firmware_driver_versions.html[Supported firmware and ESXi driver versions^].
