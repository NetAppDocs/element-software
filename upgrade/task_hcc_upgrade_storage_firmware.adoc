...
NOTE: For a complete matrix of firmware and driver firmware for your hardware, see https://docs.netapp.com/us-en/hci/docs/fw_storage_nodes.html[supported storage firmware versions for SolidFire storage nodes^].
