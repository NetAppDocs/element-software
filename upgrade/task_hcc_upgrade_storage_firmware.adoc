...
summary: As part of a NetApp SolidFire system upgrade, you upgrade the firmware associated with your storage nodes.
...
* *Updated BMC for H610S nodes*: You have upgraded the BMC version for your H610S nodes. See link:https://docs.netapp.com/us-en/hci/docs/rn_H610S_BMC_3.84.07.html[release notes and upgrade instructions^].
...
|Your management node is within a dark site without external connectivity.
a|
. Download the storage firmware upgrade package to a device that is accessible to the management node. For SolidFire storage systems, go to the Element software https://mysupport.netapp.com/site/products/all/details/element-software/downloads-tab[download page^] and download the latest storage firmware image.
