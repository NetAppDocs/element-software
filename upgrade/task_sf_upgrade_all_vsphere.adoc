...
+
IMPORTANT: When you upgrade to VMware vCenter Server 7.0U3, all versions of the NetApp Element Plug-in for vCenter Server fail to deploy. To resolve this issue, see https://kb.netapp.com/Advice_and_Troubleshooting/Hybrid_Cloud_Infrastructure/NetApp_HCI/vCenter_plug-in_deployment_fails_after_upgrading_vCenter_to_version_7.0_U3[this KB article^]. 
