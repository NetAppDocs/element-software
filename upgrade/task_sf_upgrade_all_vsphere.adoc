...
[IMPORTANT]
====
You should upgrade to NetApp Element Plug-in for vCenter Server 5.x to give you the capability to deploy the plug-in with VMware vCenter 7.0 Update 3 without having to apply a workaround. 
