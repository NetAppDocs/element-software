...
[.lead]
You need to complete extra steps when you upgrade VMware vSphere components. These steps are necessary for systems with the Element Plug-in for vCenter Server.
...
. https://techdocs.broadcom.com/[Upgrade vSphere, including vCenter Server, ESXi, VMs, and other VMware components^].
+
[IMPORTANT]
====
...
When you upgrade to VMware vCenter Server 7.0 Update 3, the Element Plug-in for vCenter Server 4.x fails to deploy. To resolve this issue using Spring Framework 4, see https://kb.netapp.com/Advice_and_Troubleshooting/Hybrid_Cloud_Infrastructure/NetApp_HCI/vCenter_plug-in_deployment_fails_after_upgrading_vCenter_to_version_7.0_U3[this KB article^].
====
