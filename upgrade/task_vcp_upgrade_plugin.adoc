...
NOTE: Beginning with management services 2.22.7, the remote plug-in was introduced with NetApp Element Plug-in for VMware vCenter Server 5.0 to comply with the VMware directive that removes support for local plug-ins. https://kb.vmware.com/s/article/87880[Learn more^].
