...
[IMPORTANT] 
=====
* Element Plug-in for vCenter 4.x is not compatible with VMware vCenter Server 8.0.
* Element Plug-in for vCenter 4.6, 4.7, 4.8, 4.9, and 4.10 is not compatible with VMware vCenter Server 6.5.
=====
...
.. (For in-house servers/dark sites) Depending on your Element Plug-in for vCenter version, a custom URL for plug-in JSON file or plug-in ZIP: 
