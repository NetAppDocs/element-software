...
[NOTE]
====
The management services 2.27 bundle includes in Element Plug-in for vCenter Server 5.5, which contains Spring Framework 6. Spring Framework 6 is only compatible with management node 12.8. When you update to management services 2.27, you must change the upgrade sequence and update the management services bundle _after_ upgrading to Element 12.8 to ensure compatibility between the management node and management services.
