...
+
Beginning with Element Plug-in for vCenter Server 5:0, the NetApp Element Remote Plugin extension point:
+
...
+
Element Plug-in for vCenter Server 4.10 or earlier, NetApp Element Configuration and Management extension points:
+
