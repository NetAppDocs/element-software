...
* <<Upgrade a management node to version 12.5 or later>>
...
== Upgrade a management node to version 12.5 or later
You can upgrade your management node to version 12.5 or later from version 12.3.x.
[role="tabbed-block"]
====
.Upgrade to management node 12.7
--
...
.Upgrade to management node 12.5
--
