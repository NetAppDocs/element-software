...
[.lead]
You can upgrade your management node to management node version 12.5 from version 11.0 or later.
...
* If you are upgrading from management node 12.3.x:
<<Upgrade a management node to version 12.5 from 12.3.x>>
* If you are upgrading from management node 12.2:
<<Upgrade a management node to version 12.5 from 12.2>>
* If you are upgrading from management node 12.0:
<<Upgrade a management node to version 12.5 from 12.0>>
* If you are upgrading from management node 11.3, 11.5, 11.7, or 11.8:
<<Upgrade a management node to version 12.5 from 11.3 through 11.8>>
* If you are upgrading from management node 11.0 or 11.1:
<<Upgrade a management node to version 12.5 from 11.1 or 11.0>>
...
You can perform an in-place upgrade of the management node from version 12.3.x to version 12.5 without needing to provision a new management node virtual machine.

NOTE: The Element 12.5 management node is an optional upgrade. It is not required for existing deployments.

.What you'll need

* The RAM of the management node VM is 24GB.
* The management node you are intending to upgrade is version 12.0 and uses IPv4 networking. The management node version 12.5 does not support IPv6.
+
...
* If you are updating your management node to version 12.5, you need management services 2.20.67 or later to proceed.
...
You can perform an in-place upgrade of the management node from version 12.2 to version 12.5 without needing to provision a new management node virtual machine.
...
You can perform an in-place upgrade of the management node from version 12.0 to version 12.5 without needing to provision a new management node virtual machine.
...
You can perform an in-place upgrade of the management node from version 11.3, 11.5, 11.7, or 11.8 to version 12.5 without needing to provision a new management node virtual machine.

NOTE: The Element 12.5 management node is an optional upgrade. It is not required for existing deployments.

.What you'll need

* The management node you are intending to upgrade is version 11.3, 11.5, 11.7, or 11.8 and uses IPv4 networking. The management node version 12.5 does not support IPv6.
+
TIP: To check the version of your management node, log in to your management node and view the Element version number in the login banner.
...
== Upgrade a management node to version 12.5 from 11.1 or 11.0
You can perform an in-place upgrade of the management node from 11.0 or 11.1 to version 12.5 without needing to provision a new management node virtual machine.
...
* The management node you are intending to upgrade is version 11.0 or 11.1 and uses IPv4 networking. The management node version 12.5 does not support IPv6.
+
TIP: To check the version of your management node, log in to your management node and view the Element version number in the login banner.
...
. On the 12.5 management node, run the `upgrade-mnode` script to retain previous configuration settings.
+
...
. (For all NetApp SolidFire all-flash storage installations with NetApp Element Plug-in for vCenter Server) Update the vCenter Plug-in on the 12.5 management node by following the steps in the link:task_vcp_upgrade_plugin.html[Upgrade the Element Plug-in for vCenter Server] topic.
