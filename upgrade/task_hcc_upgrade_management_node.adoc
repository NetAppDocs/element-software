...
[.lead]
You can upgrade your management node to management node 12.5 or later from version 12.3.x.
...
* <<upgrade_mnode_125,Upgrade a management node to version 12.5 from 12.3.x>>
* <<upgrade_mnode_127,Upgrade a management node to version 12.7 from 12.3.x or 12.5>>
...
====
[[upgrade_mnode_125]]
.Upgrade to management node 12.5 from version 12.3.x
--
...
* If you are updating your management node to version 12.5, you need management services 2.20.69 or later to proceed.
...
* Storage nodes are running Element 12.3 or later.
...
--
[[upgrade_mnode_127]]
.Upgrade to management node 12.7 from version 12.5 or 12.3.x
--
You can perform an in-place upgrade of the management node from version 12.3.x or 12.5 to version 12.7 without needing to provision a new management node virtual machine.

NOTE: The Element 12.7 management node is an optional upgrade. It is not required for existing deployments.

.What you'll need

* The RAM of the management node VM is 24GB.
* The management node you are intending to upgrade is version 12.0 and uses IPv4 networking. The management node version 12.7 does not support IPv6.
+
TIP: To check the version of your management node, log in to your management node and view the Element version number in the login banner.

* You have updated your management services bundle to the latest version using NetApp Hybrid Cloud Control. You can access NetApp Hybrid Cloud Control from the following IP: `\https://<ManagementNodeIP>`

* If you are updating your management node to version 12.7, you need management services 2.21.xx or later to proceed.
