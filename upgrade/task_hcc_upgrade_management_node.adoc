...
keywords: netapp, cluster, management node, mNode, upgrade, 10, 11.0, 11.1, 11.3, 11.5, 11.7, 12.0, 12.2, 12.3, 12.3.1
---
...
[.lead]
You can upgrade your management node to management node version 12.3.1 or 12.3 from version 11.0 or later.
...
NOTE: There are no additional functionality changes or bug fixes in management node 12.3.1. If you are already running management node 12.3, you do not need to upgrade it to 12.3.1.
