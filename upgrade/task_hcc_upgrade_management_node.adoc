...
* If you are updating your management node to version 12.5, you need management services 2.14.60 or later to proceed.
...
* If you are updating your management node to version 12.5, you need management services 2.20.xx or later to proceed.
