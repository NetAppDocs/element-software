...
* If you are updating your management node to version 12.5, you need management services 2.20.67 to proceed.
...
* The management node you are intending to upgrade is version 11.3, 11.5, 11.7, or 11.8 and uses IPv4 networking. The management node version 12.5x does not support IPv6.
+
TIP: To check the version of your management node, log in to your management node and view the Element version number in the login banner.
...
*  Storage nodes are running Element 11.3 or later.
+
NOTE: Use NetApp Hybrid Cloud Control to upgrade Element software.
