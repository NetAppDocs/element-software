...
[.lead]
You can upgrade your management node to management node 12.5 from version 12.3.x.
...
NOTE: This procedure is for upgrading to management node 12.5 from version 12.3.x. For information on upgrading management nodes 12.2 or earlier, see the https://docs.netapp.com/us-en/element-software-123/upgrade/task_hcc_upgrade_management_node.html[earlier version of the management node upgrade documentation^].
