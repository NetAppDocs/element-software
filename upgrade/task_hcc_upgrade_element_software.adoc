...
[IMPORTANT]
====
The management services 2.27 bundle contains Spring Framework 6, which is only compatible with management node 12.8. If you're updating to management services services 2.27, you must update the management services bundle _after_ upgrading to Element 12.8 to ensure compatibility between the management node and management services. 
