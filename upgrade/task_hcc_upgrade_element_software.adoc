...
|===
|Node | Element software version |Firmware updates | Approximate installation time per
node

|All nodes	|12.x	|None	|20 to 30 minutes
|H610S	| 12.x	|BIOS and BMC	|60 to 70 minutes
|H610S	| 11.7 and earlier
|Yes. The firmware updates keep the node offline for longer which increases the installation time.	|Two hours. 
