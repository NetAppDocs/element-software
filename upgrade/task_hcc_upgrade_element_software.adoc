...
. Download the storage upgrade package; go to the Element software https://mysupport.netapp.com/site/products/all/details/element-software/downloads-tab[downloads page^] and download the latest storage node image to a device that not the management node.
+
