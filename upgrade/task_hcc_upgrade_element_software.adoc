...
[NOTE]
====
Beginning with management services 2.20, the first time you select Upgrade, the End User License Agreement (EULA) pops up. Scroll down, select *I accept for current and all future updates*, and select *Save*. After you accept and save the EULA, it is recorded for all future updates.

When you accept the EULA, the automatic download feature is enabled. You will receive updates on NetApp software updates and upgrades, which you can install at your discretion and convenience. You can disable the automatic download feature by disabling network connectivity to the NetApp online software repository.
====
