...
* *End User License Agreement (EULA)*: Beginning with management services 2.20, before you can use the NetApp Hybrid Cloud Control UI or API to upgrade management services, you must perform the following steps to accept and save the EULA:
