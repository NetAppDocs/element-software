...
* *System ports*: If you are using NetApp Hybrid Cloud Control for upgrades, you have ensured that the necessary ports are open. See link:storage/reference_prereq_network_port_requirements.adoc[Network ports] for more information.
