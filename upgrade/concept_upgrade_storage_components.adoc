...
You can upgrade components individually or as part of an end-to-end system upgrade. For upgrade instructions, see the link:../upgrade/task_sf_upgrade_all.html[upgrades overview].
