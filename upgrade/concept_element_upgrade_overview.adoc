...
* Depending on your Element software version, the following nodes are not supported. If you attempt to upgrade one of these nodes to an unsupported Element version, you will see an error stating that this node is not supported by Element 12.x.
