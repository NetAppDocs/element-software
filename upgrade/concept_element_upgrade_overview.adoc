...
+
If you're deploying a new management node with version 12.8, you can use the the NetApp Hybrid Cloud Control or REST API to perform component upgrades in the order listed in the <<sys_upgrade,system upgrade sequence>>.
