...
* Beginning with management services 2.20, before you can use the NetApp Hybrid Cloud Control UI or API to upgrade management services, you must perform the following steps to accept and save the *End User License Agreement (EULA)*:
...
You can run health checks using the NetApp Hybrid Cloud Control UI, the NetApp Hybrid Cloud Control API, or the HealthTools suite:
