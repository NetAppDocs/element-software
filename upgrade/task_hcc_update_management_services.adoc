...
Beginning with management services 2.20, you have accepted and saved the End User License Agreement (EULA) before using the NetApp Hybrid Cloud Control UI or API to upgrade management services:
