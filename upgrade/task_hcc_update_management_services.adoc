...
+
NOTE: If your installation cannot access the internet, only the current software version is shown. If your installation has external connectivity, but cannot access the NetApp online repository, check your link:https://docs.netapp.com/us-en/hci/docs/task_mnode_configure_proxy_server.html[proxy configuration^].
