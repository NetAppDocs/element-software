---
sidebar: sidebar
permalink: upgrade/task_sf_upgrade_all.html
summary: You can upgrade NetApp SolidFire all-flash storage system and all of its components.
keywords: netapp, solidfire, cluster, upgrade, element
---

= Upgrade your NetApp SolidFire all-flash storage system for Element 12.3.x
