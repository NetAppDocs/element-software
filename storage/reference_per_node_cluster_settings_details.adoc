...
The following list describes the cluster settings for a storage node indicated from the *Cluster Settings* page of the per-node UI (`https://<node_IP>:442/hcc/node/cluster-settings`).
