...
* link:task_data_protection_back_up_a_volume_snapshot_to_an_amazon_s3_object_store.html[Back up a volume snapshot to an Amazon S3 object store]
* link:task_data_protection_back_up_a_volume_snapshot_to_openstack_swift.html[Back up a volume snapshot to an OpenStack Swift object store]
