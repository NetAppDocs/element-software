...
* xref:task_system_manage_snmp_configure_snmp_traps.html[Configure SNMP traps]
* xref:task_system_manage_snmp_view_managed_object_data.html[View managed object data using management information base files]
