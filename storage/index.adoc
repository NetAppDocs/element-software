...
Element 12.5 also contains robustness improvements for existing cluster events such as link:../storage/reference_monitor_event_types.html#csum_event[cSumEvent] and link:../storage/reference_monitor_event_types.html#network_event[networkEvent].
