...
* For H410S and H610S nodes, link:https://docs.netapp.com/us-en/element-software/storage/task_post_deploy_credential_change_ipmi_password.html[change default IPM password].
...
| link:https://docs.netapp.com/us-en/hci/docs/task_hci_credentials_vcenter_esxi.html%20#update-the-esxi-password-by-using-the-management-node-rest-api[Update credentials for vCenter and ESXi hosts^].
