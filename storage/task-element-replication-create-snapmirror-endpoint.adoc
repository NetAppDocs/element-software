...
[.lead]
You must create a SnapMirror endpoint before you can create a replication relationship. You can only perform this task in the Element software web UI or using the link:../api/reference_element_api_abortsnapmirrorrelationship.html[SnapMirror API methods].
