...
[.lead]
In SolidFire storage systems, user accounts, also known as tenant accounts, enable clients to connect to volumes on a node. When you create a volume, it is assigned to a specific user account.
