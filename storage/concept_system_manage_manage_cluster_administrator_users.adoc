...
+
See link:../api/concept_element_api_about_the_api.html[NetApp Element Software API Reference].
...
link:concept_system_manage_manage_ldap.html[Enable LDAP authentication with the Element user interface]
