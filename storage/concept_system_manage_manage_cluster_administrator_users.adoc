...
NOTE: To change the password for the cluster administrator in the management node, see management node documentation. https://docs.netapp.com/us-en/hci/docs/task_mnode_work_overview.html[Management node overview]
...
* link:task_system_manage_enable_ldap_authentication.adoc[Enable LDAP authentication with the Element user interface]
* link:task_system_manage_disable_ldap.adoc[Disable LDAP]
