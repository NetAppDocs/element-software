...
sidebar: sidebar
keywords: element, solidfire, cluster admin, account, create, change
...
NOTE: To change the password for the cluster administrator in the management node, see the  link:concept_mnode_work_with_the_management_node.html[management node overview].
