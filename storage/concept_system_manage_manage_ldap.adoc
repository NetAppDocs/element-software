...
+
image::../media/element_new_ldap_servers.jpg[Screenshot of the General Settings information]
...
. To create a user in this group so that anyone can log in, complete the following:
 .. Click *User* > *View*.
+
image::../media/element_new_cluster_admin.jpg[Screenshot of the Create a new user page]
