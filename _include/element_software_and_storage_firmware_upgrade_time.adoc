...
+
^3^Beginning with Element 12.7, the SF2405, SF4805, SF9605, SF9608, SF19210, and SF38410 storage nodes and FC0025 and SF-FCN-01 FC nodes are not supported. If you attempt to upgrade one of these nodes to Element 12.7, you will see an error stating that this node is not supported by Element 12.7.
