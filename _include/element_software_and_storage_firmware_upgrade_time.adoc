...
+
^3^Beginning with Element 12.7, the SF2405 storage node is not supported. If you upgrade an SF2405 storage node, you will see an error stating that this node is not supported by Element 12.7.
