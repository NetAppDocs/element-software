...
+
^3^Beginning with Element 12.7, the SF2405 and SF9608 storage nodes and FC0025 and SF-FCN-01 FC nodes are not supported. If you upgrade one of these storage nodes to Element 12.7, you will see an error stating that this node is not supported by Element 12.7.
