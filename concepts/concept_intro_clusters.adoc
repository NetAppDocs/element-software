...
See link:https://docs.netapp.com/us-en/hci/docs/task_mnode_manage_storage_cluster_assets.html[create and manage storage cluster assets^] for more information on working with management node storage cluster assets.
