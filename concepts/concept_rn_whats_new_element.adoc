...
=== Dynamic Node Rating for SolidFire Enterprise SDS

Dynamic node rating allows for performance to scale with the number of cores on the platform. For release 12.3.1, when the number of cores is greater than 16, IOPS is capped at 100K.
