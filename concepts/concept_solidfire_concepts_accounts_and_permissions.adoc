...
The https://docs.netapp.com/us-en/hci/docs/concept_hci_clusters.html#authoritative-storage-clusters[authoritative storage cluster^] is the storage cluster that NetApp Hybrid Cloud Control uses to authenticate users.
