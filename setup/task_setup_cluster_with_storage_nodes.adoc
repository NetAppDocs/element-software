...
.Steps
. link:../setup/concept_setup_cluster_with_storage_nodes.html[Configure a storage node]
. link:../setup/task_setup_create_a_storage_cluster[Create a storage cluster]
. link:../setup/task_post_deploy_access_the_element_software_user_interface.html[Log in to the Element software user interface]
