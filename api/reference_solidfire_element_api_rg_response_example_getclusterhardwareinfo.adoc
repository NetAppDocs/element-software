---
permalink: api/reference_solidfire_element_api_rg_response_example_getclusterhardwareinfo.html
sidebar: sidebar
keywords: response,example,getclusterhardwareinfo
summary: 'The GetClusterHardwareInfo method returns a response similar to the following example.'
---
