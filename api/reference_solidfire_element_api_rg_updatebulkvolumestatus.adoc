---
permalink: api/reference_solidfire_element_api_rg_updatebulkvolumestatus.html
sidebar: sidebar
...
key
a|
The key assigned during initialization of a xref:reference_solidfire_element_api_rg_startbulkvolumeread.adoc[StartBulkVolumeRead] or xref:reference_solidfire_element_api_rg_startbulkvolumewrite.adoc[StartBulkVolumeWrite] session.
a|
string
a|
None
