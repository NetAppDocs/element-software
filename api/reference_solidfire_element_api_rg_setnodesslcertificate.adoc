---
permalink: api/reference_solidfire_element_api_rg_setnodesslcertificate.html
sidebar: sidebar
keywords: ssl,certificate,set,setting,private,key,setnodesslcertificate
summary: 'You can use the SetNodeSSLCertificate method to set a user SSL certificate and private key for the management node.'
---
