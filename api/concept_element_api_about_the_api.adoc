...
link:../api/reference_element_api_adddrives.html[Learn about drive API methods]
...
link:../api/reference_element_api_addidpclusteradmin.htmll[Learn about multi-factor authentication API methods]

== Session authentication API methods
You can use session-based authentication to manage user sessions.

link:../api/reference_element_api_listauthsessionbyclusteradmin.html[Learn about session authentication API methods]
