---
permalink: api/reference_solidfire_element_api_rg_listvirtualvolumes.html
sidebar: sidebar
...
a|
xref:reference_solidfire_element_api_rg_virtualvolume.adoc[virtualVolume] array
|===
