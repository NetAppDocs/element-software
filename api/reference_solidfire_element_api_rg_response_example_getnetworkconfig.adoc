---
permalink: api/reference_solidfire_element_api_rg_response_example_getnetworkconfig.html
sidebar: sidebar
keywords: response,example,getnetworkconfig
summary: 'The GetNetworkConfig method returns a response similar to the following example.'
---
= GetNetworkConfig
:icons: font
:imagesdir: ../media/
...
[.lead]
The GetNetworkConfig method returns a response similar to the following example.
