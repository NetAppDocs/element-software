---
permalink: api/reference_solidfire_element_api_rg_response_example_getnodehardwareinfo_fibre_channel.html
sidebar: sidebar
keywords: response,example,getnodehardwareinfo
summary: 'The GetNodeHardwareInfo method for Fibre Channel nodes returns a response similar to the following example.'
---
