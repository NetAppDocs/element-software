---
permalink: api/reference_solidfire_element_api_rg_getsslcertificate.html
sidebar: sidebar
keywords: SSL,certificate,cert,get,getting,active,GetSSLCertificate
summary: 'You can use the GetSSLCertificate method to retrieve the SSL certificate that is currently active on the storage nodes of the cluster.'
---
= GetSSLCertificate
:icons: font
:imagesdir: ../media/
...
certificate
a|
The full PEM-encoded text of the certificate.
a|
string
a|
details
