---
permalink: api/reference_solidfire_element_api_rg_response_example_getlldpinfo.html
sidebar: sidebar
keywords: response,example,getlldpinfo
summary: 'The GetLldpInfo method returns a response similar to the following example.'
---
= GetLldpInfo
:icons: font
:imagesdir: ../media/
