---
permalink: api/reference_solidfire_element_api_rg_listsnapmirrorvservers.html
sidebar: sidebar
...
a|
xref:reference_solidfire_element_api_rg_snapmirrorvserver.adoc[snapMirrorVserver] array
|===
