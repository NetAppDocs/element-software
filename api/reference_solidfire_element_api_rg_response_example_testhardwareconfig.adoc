---
permalink: api/reference_solidfire_element_api_rg_response_example_testhardwareconfig.html
sidebar: sidebar
keywords: response,example,testhardwareconfig
summary: 'The TestHardwareConfig method returns a response similar to the following example.'
---
= TestHardwareConfig
:icons: font
:imagesdir: ../media/
