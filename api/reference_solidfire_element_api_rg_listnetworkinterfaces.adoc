---
permalink: api/reference_solidfire_element_api_rg_listnetworkinterfaces.html
sidebar: sidebar
...
a|
xref:reference_solidfire_element_api_rg_networkinterface.adoc[networkInterface] array
|===
