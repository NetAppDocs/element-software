---
permalink: api/reference_solidfire_element_api_rg_getnodesslcertificate.html
sidebar: sidebar
keywords: ssl,cert,certificate,get,getting,getnodesslcertificate,active
summary: 'You can use the GetNodeSSLCertificate method to retrieve the SSL certificate that is currently active on the management node.'
---
