---
permalink: api/reference_solidfire_element_api_rg_response_example_listactivenodes.html
sidebar: sidebar
keywords: response,example,listactivenodes
summary: 'The ListActiveNodes method returns a response similar to the following example.'
---
= ListActiveNodes
:icons: font
:imagesdir: ../media/
