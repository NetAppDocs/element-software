---
permalink: api/reference_solidfire_element_api_rg_startclusterpairing.html
sidebar: sidebar
...
clusterPairingKey
a|
A string of characters that is used by the xref:reference_solidfire_element_api_rg_completeclusterpairing.adoc[CompleteClusterPairing] API method.
a|
string
a|
clusterPairID
