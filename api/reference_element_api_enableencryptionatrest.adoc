...
[NOTE]
====
* This method does not enable software encryption at rest. This can only be done using the link:../api/reference_element_api_createcluster.html[create cluster method^] with `enableSoftwareEncryptionAtRest` set to `true`.
