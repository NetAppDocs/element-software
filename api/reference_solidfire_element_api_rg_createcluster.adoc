---
permalink: api/reference_solidfire_element_api_rg_createcluster.html
sidebar: sidebar
...
NOTE: After you log in to the master node for the cluster and run the xref:reference_solidfire_element_api_rg_getbootstrapconfig.adoc[GetBootStrapConfig] method to get the IP addresses for the rest of the nodes that you want to include in the cluster, you can run the CreateCluster method against the master node for the cluster.
