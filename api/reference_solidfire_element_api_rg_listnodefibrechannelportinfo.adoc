---
permalink: api/reference_solidfire_element_api_rg_listnodefibrechannelportinfo.html
sidebar: sidebar
...
a|
xref:reference_solidfire_element_api_rg_fibrechannelport.adoc[fibreChannelPort] array
|===
