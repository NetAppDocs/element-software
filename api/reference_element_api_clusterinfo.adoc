...
a|
The protection scheme used by default for new volumes, unless a protection scheme is provided with the xref:reference_element_api_createvolume.adoc[CreateVolume] method call.
a|
string
a|
