...
* primaryTotalHeat: Node primary total IOPS / node configured IOPS averaged over a long time period
* recentPrimaryTotalHeat: Node primary total IOPS / node configured IOPS averaged over a recent time period
* recentTotalHeat: Node total IOPS / node configured IOPS averaged over a recent time period
* totalHeat: Node total IOPS / node configured IOPS averaged over a long time period
a|
JSON object
a|
