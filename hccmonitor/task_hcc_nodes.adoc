---
sidebar: sidebar
permalink: hccmonitor/task_hcc_nodes.html
...
You can view storage information for your multiple node systems. If link:concept_hcc_custom_protection_domains.html[custom protection domains^] are assigned, you can see which protection domains are assigned to specific nodes.
...
TIP: To view the number of storage, look at the NetApp Hybrid Cloud Control (HCC) Dashboard. See link:task_hcc_dashboard.html[Monitor storage resources with the HCC Dashboard].
