...
NOTE: Starting with Element 12.5, substeps (a) to (e) are performed automatically. For management node 12.5, proceed to <<substep_f_recover_config_time_sync,substep (f)>> to complete the time sync configuration.
