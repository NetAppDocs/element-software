...
[NOTE]
====
Starting with Element 12.5, substeps (a) to (e) are performed automatically. For management node 12.5, proceed to substep (f) to complete the time sync configuration. As a result, when you run the <<step_6_recover_mnode_redeploy,redeploy command>>, you see output in the redeploy script similar to the following:
----
