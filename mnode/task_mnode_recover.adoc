...
[NOTE]
====
Beginning with the management services 2.19 release, substeps (a) to (e) are performed automatically. As a result, when you run the <<step_6_recover_mnode_redeploy,redeploy command>>, you see output in the redeploy script similar to the following:
----
