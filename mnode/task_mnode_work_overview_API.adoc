...
=== Asset configuration
* link:task_mnode_enable_activeIQ.html[Enable Active IQ and NetApp monitoring][.line-through]#Enable Active IQ and NetApp HCI monitoring#
...
* link:task_mnode_manage_storage_cluster_assets.html[Create and manage storage cluster assets]
[.line-through]#* link:task_mnode_remove_assets.html[Remove an asset from the management node]#
* link:https://docs.netapp.com/us-en/hci/docs/task_hcc_collectlogs.html#use-the-rest-api-to-collect-netapp-hci-logs[Use the REST API to collect Element system logs][.line-through]#Use the REST API to collect NetApp HCI logs#
