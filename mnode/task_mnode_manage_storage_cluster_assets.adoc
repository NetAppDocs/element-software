...
* If you are adding more than one storage node, you have read and understood the limitations of the link:https://docs.netapp.com/us-en/hci/docs/concept_hci_clusters.html#authoritative-storage-clusters[Authoritative cluster^] and multiple storage cluster support.
+
NOTE: All users defined on the authoritative cluster are defined as users on all other clusters tied to the NetApp Hybrid Cloud Control instance.
...
.. Select *Authorize* to begin a session.
.. Close the window.
. Select *DELETE /clusters/{storageId}*.
. Select *Try it out*.
...
* link:https://docs.netapp.com/us-en/hci/docs/concept_hci_clusters.html#authoritative-storage-clusters[Authoritative cluster^]
