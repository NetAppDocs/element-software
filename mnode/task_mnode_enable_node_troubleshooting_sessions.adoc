...
.Before you begin
* *Write permission*: Verify that you have write permissions to the current working directory.
...
* Configure `supportAdmin` access by using the link:../storage/concept_system_manage_manage_cluster_administrator_users.html#view-cluster-admin-details[Element UI].
