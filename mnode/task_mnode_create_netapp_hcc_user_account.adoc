...
Use the new HCC user account that you created in <<Set up a HCC user account>> to add a controller asset to the management node. See link:task_mnode_add_assets.html[Add a control asset to the management node].
