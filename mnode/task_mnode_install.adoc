...
Prior to following this procedure, you should have an understanding of link:../concepts/concept_solidfire_concepts_volumes.html#persistent-volumes[Persistent volumes] and whether or not you want to use them. Persistent volumes are optional but recommended for management node configuration data recovery in the event of a VM loss.
...
[NOTE]
====
Starting with Element  12.5, substeps (a) to (e) are performed automatically. As a result, when you run the link:task_mnode_install.html#set-up-the-management-node[setup command], you see output in the setup script similar to the following:
----
[2021-09-10T22:17:33.014675Z]:[config_util:1649] INFO:Setting up NTP configuration using MVIP: 10.117.148.204.
[2021-09-10T22:17:33.076224Z]:[config_util:1664] INFO:NTP configuration file setup complete.
[2021-09-10T22:17:33.076717Z]:[config_util:1666] INFO:Setting system clock to match MVIP's.
[2021-09-10T22:17:39.205925Z]:[config_util:1671] INFO:NTP setup complete.
----
Proceed to <<substep_f_install_config_time_sync,substep (f)>> to complete the time sync configuration procedure.

It is not recommended to edit the NTP after you complete the time sync configuration because it affects the NTP when you run the setup command on the management node.
====
...
.. [[substep_f_install_config_time_sync]]*Starting with Element 12.5, you can manually continue the procedure from here.*
+
