...
Element 12.8 supports vSphere 7.x and 8. As a result, you must upgrade the VM hardware version on the management node to ESXi 6.7 or later before you upgrade a management node. This ensures that you have a supported ESXi version. 
