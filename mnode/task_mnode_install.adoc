...
. Add a vCenter controller asset for [.line-through]#NetApp HCI monitoring (NetApp HCI installations only) and# NetApp Hybrid Cloud Control [.line-through]#(for all installations)# to the management node known assets:
