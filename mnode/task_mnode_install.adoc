...
[NOTE]
====
Beginning with the management services 2.19 release, substeps (a) to (e) are performed automatically. As a result, when you run the link:task_mnode_install.html#set-up-the-management-node[setup command], you see output in the setup script similar to the following:
----
