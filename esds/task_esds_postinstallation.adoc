...
NOTE: You can use the link:https://github.com/NetApp-Automation/nar_solidfire_cluster_config[`nar_solidfire_cluster_config`^] Ansible role provided by NetApp to create a cluster. If you want to manually create the cluster, see the steps outlined below.
