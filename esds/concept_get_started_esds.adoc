...
== Dynamic node rating
Dynamic node rating was introduced in Element 12.3.1 and enables you to leverage 24 supported CPUs per eSDS platform as opposed to today’s model of a single CPU per platform.
