...
== Dynamic node rating (_NEW in Element 12.3.1!_)

Dynamic node rating is a new feature in Element 12.3.1, which enables you to leverage 24 supported CPUs per eSDS platform as opposed to today’s model of a single CPU per platform.
