...
. Perform the following steps in the Element UI:
 ...
 .. Make a note of the serial number of the drive. This will help you locate the corresponding slot number of the drive in the Integrated Dell Remote Access Contoller (iDRAC).
