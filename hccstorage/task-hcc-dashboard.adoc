...
TIP: To view cluster health, also look at the SolidFire Active IQ Dashboard. See link:https://docs.netapp.com/us-en/hci/docs/task_hcc_activeiq.html[Monitor performance, capacity, and cluster health in NetApp SolidFire Active IQ^].
