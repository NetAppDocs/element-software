...
You can view storage information for your multiple node systems. If link:../concepts/concept_solidfire_concepts_data_protection.html#custom_protection_domains[custom protection domains] are assigned, you can see which protection domains are assigned to specific nodes.
