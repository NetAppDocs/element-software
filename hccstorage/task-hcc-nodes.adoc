...
You can view storage information for your multiple node systems. If link:../storage/concept_intro_custom_protection_domains.html[custom protection domains] are assigned, you can see which protection domains are assigned to specific nodes.
